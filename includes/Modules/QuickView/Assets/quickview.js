document.addEventListener(
	...
	function () {
		...
		// Open modal on click
		document.querySelectorAll( '.shopspark-quick-view-btn' ).forEach(
			button => {
